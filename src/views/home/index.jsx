...
const Home = () => {
  ...
  return (
    <div>
      <Navigation />
      <div className="flex w-full items-center justify-between bg-red-300 p-5 md:max-h-60 md:justify-evenly">
        ...
        <img src={bannerImg} alt="banner" className="h-48 object-cover md:h-60 md:p-5" />
      </div>
      <div>
